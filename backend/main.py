...
def architecture_status():
    ...
    return {
        "layers": [
            ...
            {"name": "Audit", "status": "active", "detail": "Hash-linked local record plus optional external sink"},
        ],
...
def lyzr_evidence():
    ...
    return {
        ...
        "studio_agents": {"buyer_id": buyer_id, "supplier_id": supplier_id, "both_configured": bool(buyer_id and supplier_id)},
        "rai": {"custom_guardrail_configured": bool(os.getenv("LYZR_GUARDRAIL_URL")), "policy_id_configured": bool(os.getenv("LYZR_RAI_POLICY_ID")), "fail_closed": bool(os.getenv("LYZR_GUARDRAIL_URL"))},
        "aims": {"native_ingestion_claimed": False, "external_sink_configured": bool(os.getenv("LYZR_AIMS_WEBHOOK_URL")), "local_hash_chain": True, "export_envelope": "autobus.aims-event.v1"},
...
def lyzr_status():
    ...
    result = {
        ...
        "aims": {
            "agent_interactions_use_lyzr_session_ids": True,
            "external_sink_configured": bool(os.getenv("LYZR_AIMS_WEBHOOK_URL")),
        },
    }
    if configured:
        try:
...
def start_negotiation(
    ...
    if lyzr_ready:
        ...
        buyer_environment = AgentEnvironment(
            ...
            shared_context={"negotiation_id": neg_id},
        )
    ...
    return {
        ...
        "governance": {
            ...
            "aims_sink_configured": bool(governance.aims_webhook_url),
...
def governance_status():
    ...
    return {
        ...
        "aims_fallback": {
            "enabled": True,
            "queued_events": outbox["queued_events"],
            "path": outbox["path"],
            "envelope": "autobus.aims-event.v1",
        },
