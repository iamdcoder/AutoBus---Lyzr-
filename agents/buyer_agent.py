...
"""
        ...
        return f"""
AUTOBUS_SECURITY_BOUNDARY: buyer_private_session
SESSION_ID: {self.session_id}
...
IMPORTANT: "accepted_offer" must be null for every action except "accept".
Only when "action" is "accept", set "accepted_offer" to "supplier".
Never include "accepted_offer" alongside "offer", "counter", or "walk_away".
"""
