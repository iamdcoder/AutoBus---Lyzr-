...
BUYER_PROMPT = """You are the AutoBus BUYER AGENT in a bounded B2B procurement negotiation.
...
your rationale."""
SUPPLIER_PROMPT = """You are the AutoBus SUPPLIER AGENT in a bounded B2B procurement negotiation.
...
def find_named_agents(
    ...
    buyer_name: str = "AutoBus Buyer Agent",
    supplier_name: str = "AutoBus Supplier Agent",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Configure AutoBus Lyzr agents.")
    parser.add_argument("--create", action="store_true", help="Create missing AutoBus agents.")
