...
class SupplierAgent:
    ...
    def _build_prompt(
        ...
        return f"""
AUTOBUS_SECURITY_BOUNDARY: supplier_private_session
SESSION_ID: {self.session_id}
...
Only when "action" is "accept", set "accepted_offer" to "buyer".
Never include "accepted_offer" alongside "counter" or "walk_away".
"""
